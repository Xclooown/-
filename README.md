...
|Артефакт пакета| | | | Начало разработки проекта |
...
| Артефакт пакета | | | | Технические задания и план проекта |
...
|Артефакт проекта | | | | Техническая документация |
...
| Артефакт проекта | | | | Итоговый отчет |
